...
for HV in HV_list:
    ...
    MaxNum_Time_list = np.loadtxt("Ch2max_{}HV_{}Vth_{}Vamp.txt".format(HV, Vth, Vamp), delimiter=',')
    Hist_Plot(MaxNum_Time_list)
    plt.title('Histogram of time for max value - {}HV {}Vth {}Vamp'.format(HV, Vth, Vamp))
    plt.savefig("Ch2time_maximum_{}HV_{}Vth_{}Vamp.png".format(HV,Vth,Vamp))
    print("Ch2time_maximum_{}HV_{}Vth_{}Vamp.png is saved!".format(HV,Vth,Vamp))
...
MaxNum_Time_Accumlist = np.loadtxt("Ch2maxAccum_{}Vth_{}Vamp.txt".format(HV, Vth, Vamp), delimiter=',')
...
plt.savefig("Ch2time_maximumAccum_{}Vth_{}Vamp.png".format(Vth,Vamp))
print("Ch2time_maximumAccum_{}Vth_{}Vamp.png is saved!".format(Vth,Vamp))
