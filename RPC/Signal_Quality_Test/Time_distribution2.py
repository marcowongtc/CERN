...
for HV in HV_list:
    ...
    print("Ch2 Analysis Count: {}".format(len(Time_width_Totlist)))
    ...
    np.savetxt("Ch2LeadingTime_{}HV_{}Vth_{}Vamp.txt".format(HV,Vth,Vamp), Leading_Time_Totlist, delimiter=',')
    np.savetxt("Ch2TrailingTime_{}HV_{}Vth_{}Vamp.txt".format(HV,Vth,Vamp), Trailing_Time_Totlist, delimiter=',')
    np.savetxt("Ch2TimeWidth_{}HV_{}Vth_{}Vamp.txt".format(HV,Vth,Vamp), Time_width_Totlist, delimiter=',')
    np.savetxt("Ch2PeakNo_{}HV_{}Vth_{}Vamp.txt".format(HV,Vth,Vamp), Peak_No_Totlist, delimiter=',')
...
np.savetxt("Ch2AccumLeadingTime_{}Vth_{}Vamp.txt".format(Vth,Vamp), Leading_Time_Accumlist, delimiter=',')
np.savetxt("Ch2AccumTrailingTime_{}Vth_{}Vamp.txt".format(Vth,Vamp), Trailing_Time_Accumlist, delimiter=',')
np.savetxt("Ch2AccumTimeWidth_{}Vth_{}Vamp.txt".format(Vth,Vamp), Time_width_Accumlist, delimiter=',')
np.savetxt("Ch2AccumPeakNo_{}Vth_{}Vamp.txt".format(Vth,Vamp), Peak_No_Accumlist, delimiter=',')
