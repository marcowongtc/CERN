...
#Peak No Plot
for HV in HV_list:
    Peak_No_Totlist = np.loadtxt("Ch1PeakNo_{}HV_{}Vth_{}Vamp.txt".format(HV, Vth, Vamp), delimiter=',')
    PeakNo_Plot(Peak_No_Totlist)
    plt.title('Histogram of PeakNo - {}HV {}Vth {}Vamp'.format(HV,Vth, Vamp))
    plt.savefig("Ch1PeakNo_{}HV_{}Vth_{}Vamp.png".format(HV,Vth,Vamp))
    print("Ch1PeakNo_{}HV_{}Vth_{}Vamp.png is saved!".format(HV,Vth,Vamp))
    plt.clf() #clear plot
...
plt.savefig("Ch1AccumPeakNo_{}Vth_{}Vamp.png".format(Vth,Vamp))
print("Ch1AccumPeakNo_{}Vth_{}Vamp.png is saved!".format(Vth,Vamp))
plt.clf() #clear plot
