...
for HV in HV_list:
    ...
    Ch1Leading_Time_Totlist = np.array([])
            ...
            for value in channel_column_values:
                ...
                if value > 0.6:
                    ...
                    if len(Ch1Leading_Time_list) == len(Ch1Trailing_Time_list):
                        ...
                        Ch1Leading_Time_Totlist = np.append(Ch1Leading_Time_Totlist, Ch1Leading_Time_list[0])
                        Filename_Ch1havepeak = np.append(Filename_Ch1havepeak, filename)
                        
                        #word
                        Ch1Leading = Ch1Leading_Time_list[0]
                        print("Ch1Leading:{}".format(Ch1Leading))
            ...
            if value > 0.6:
                ...
                if len(Ch2Leading_Time_list) == len(Ch2Trailing_Time_list):
                    ...
                    if len(Ch2Leading_Time_list) == 1:
                        ...
                        #word
                        Ch2leading = Ch2Leading_Time_list[0]
                        print("Ch2Leading:{}".format(Ch2leading))
                        print("Time width:{}".format(Ch2leading-Ch1Leading))
    ...
    Interval_Ch1Ch2_list = Ch2Leading_Time_Totlist - Ch1Leading_Time_Totlist
    ...
    print("Ch1 Analysis Count: {}".format(len(Ch1Leading_Time_Totlist)))
