...
def countFile(HV, Vth_list, Vamp_list):
    NtotCh1 = 0
    NtotCh2 = 0
    Ntot = 0
    print("---------------------------")
    ...
    for filename in FilenameList:
        if filename.endswith('.csv') and "Ch1" in filename and str(str(HV)+"KHV") in filename and str(str(Vth_list[0]) + "Vth") in filename and str(str(Vamp_list[0]) + "Vamp") in filename:
            NtotCh1 += 1
        if filename.endswith('.csv') and "Ch1" in filename and str(str(HV)+"KHV") in filename and str(str(Vth_list[0]) + "Vth") in filename and str(str(Vamp_list[0]) + "Vamp") in filename:
            NtotCh2 += 1
...
print("{}Vth_{}Vamp_dataset".format(Vth_list[0],Vamp_list[0]))
...
for HV in HV_list:
    ...
    Ntot = countFile(HV, Vth_list, Vamp_list)
    ...
    # Loop through all files in the directory
    for filename in FilenameList:
        if filename.endswith('.csv') and "Ch2" in filename and str(str(HV)+"KHV") in filename and str(str(Vth_list[0]) + "Vth") in filename and str(str(Vamp_list[0]) + "Vamp") in filename:
...
#checking whether there eff_array and err_array is working
